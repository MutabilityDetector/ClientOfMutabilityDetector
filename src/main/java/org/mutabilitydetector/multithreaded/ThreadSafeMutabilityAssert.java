 ...
 */
public final class ThreadSafeMutabilityAssert {

    private ThreadSafeMutabilityAssert() { }

    private final static ThreadSafeMutabilityAsserter defaultAsserter = ThreadSafeMutabilityAsserter.configured(OUT_OF_THE_BOX_CONFIGURATION);
